	...
	questions: [
		{
			...
			answers: [
				...
				},
				{
					...
					advice: "«Вы всё делаете правильно. Советую также обратить внимание на обновляющий крем для лица «Энергия протинола» от Avon , который помимо увлажнения обеспечивает 7 признаков молодой кожи за 7 дней*» * На основании исследования потребительского восприятия № 23-004 при участии 129 женщин.",
				},
				{
					Answer: false,
				...
				},
				{
					...
					advice: "«Обладательницы жирной кожи часто сторонятся увлажняющих кремов. При этом активно используют вяжущие и подсушивающие средства, которые помимо жира поглощают еще и влагу. Результат — обезвоживание. Пользуйтесь увлажняющими кремами, такими как обновляющий крем для лица “Энергия протинола” от Avon, который также обеспечивает 7 признаков молодой кожи за 7 дней*».* На основании исследования потребительского восприятия № 23-004 при участии 129 женщин.",
				},
			],
		},
		{
			...
			answers: [
				...
				},
				{
					...
					advice: "«Макияж и уход — две разные вещи. Тональные средства не могут удовлетворить всех потребностей кожи. Перед их нанесением используйте обновляющий крем для лица “Энергия протинола” от Avon, который обеспечивает 7 признаков молодой кожи за 7 дней*».<br>* На основании исследования потребительского восприятия № 23-004 при участии 129 женщин.",
				},
				{
					Answer: false,
					text: "Если мне нужно «засиять», я иду в салон красоты.",
					advice: "«А почему нужен особый повод для красивого цвета лица? Приятно же ежедневно поражать всех своей сияющей кожей. Введите в ритуал обновляющий крем для лица “Энергия протинола” от Avon, который придает коже сияние и обеспечивает 7 признаков молодой кожи за 7 дней*»<br>* На основании исследования потребительского восприятия № 23-004 при участии 129 женщин.",
				},
				{
					Answer: true,
